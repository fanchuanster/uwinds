...
module.exports = "<div class=\"home-page\">\n\n  <div class=\"banner\" *appShowAuthed=\"false\">\n    <div class=\"container\">\n      <h1 class=\"logo-font\">API demo - Time zone checker</h1>\n    </div>\n  </div>\n\n  <div class=\"container page\">\n    <div class=\"row\">\n      <label>Usages:\n        <ul>\n          <li>input a city name you would like to check timezone</li>\n          <li>*in the backend, it will call Google APIs to get the city location</li>\n          <li>*then get the time zone with the city location</li>\n        </ul>\n      </label>\n    </div>\n    <div class=\"row\">\n      <label>Input city name:\n        <input class=\"form-control\" (input)=\"onSearchChange($event.target.value)\" />\n      </label>\n      <label>Time Zone:\n        <div>{{timezone}}</div>\n      </label>\n    </div>\n    \n    <div class=\"row\">\n      <ul>\n        <li *ngFor=\"let i of predictions\">{{i.description}}</li>\n      </ul>\n    </div>\n    \n    <!-- <div>Time: {{ time | async }}</div> -->\n  </div>\n</div>\n"
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(router, tagsService, userService, apiService) {
        this.router = router;
        this.tagsService = tagsService;
        this.userService = userService;
        this.apiService = apiService;
        this.key = "AIzaSyARJnJeSRuwWaW9Y4LMBnV8MqwaybrRKq0";
        this.sessiontoken = '1234567890';
        this.timeOutDuration = 500;
        this.time = new rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"](function (observer) {
            setInterval(function () { return observer.next(new Date().toString()); }, 1000);
        });
    }
    HomeComponent.prototype.getTimeZoneInfo = function (loc) {
        var _this = this;
        ...
        this.apiService.get('/timezone/json?location=' + encodeURI(loc.lat + "," + loc.lng) + '&timestamp=1331161200&key=' + this.key + '&sessiontoken=' + this.sessiontoken)
            ...
            _this.timezone = data.timeZoneName + " @" + data.rawOffset / 3600;
            return data;
        });
    };
    HomeComponent.prototype.getPlaceInfo = function (predictions) {
        var _this = this;
        this.timezone = "";
    ...
    HomeComponent.prototype.onSearchChange = function (searchValue) {
        ...
        this.timeOut = setTimeout(function () {
            ...
            _this.apiService.get('/place/autocomplete/json?input=' + encodeURI(searchValue) + '&key=' + _this.key + '&sessiontoken=' + _this.sessiontoken)
                .subscribe(function (data) {
                _this.predictions = data.predictions;
                _this.getPlaceInfo(_this.predictions);
                return data;
            });
    ...
    HomeComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"],
            _core__WEBPACK_IMPORTED_MODULE_4__["TagsService"],
            _core__WEBPACK_IMPORTED_MODULE_4__["UserService"],
            _core__WEBPACK_IMPORTED_MODULE_4__["ApiService"]])
    ], HomeComponent);
...
module.exports = __webpack_require__(/*! C:\Users\donwen.CORPDOM\WS\UWind\uwinds2\8117K\www\angular-realworld-example\src\main.ts */"./src/main.ts");
